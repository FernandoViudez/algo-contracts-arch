...
# fill minimal balance from other account
...
goal clerk dryrun -t transf-signed-final.tx --dryrun-dump -o dr.msgp
tealdbg debug /data/core/approval.teal -d dr.msgp --group-index 2
...
# goal account info -a $MINTER_REQUEST_ACCOUNT
